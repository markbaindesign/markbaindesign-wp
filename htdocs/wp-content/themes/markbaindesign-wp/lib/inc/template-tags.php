...
if ( ! function_exists( 'lfstyle_custom_related_posts' ) ) :
/**
 * Show a set of related posts based on tags
 */
function lfstyle_custom_related_posts() {
    	global $post;  
 	$orig_post = $post;  
	 ...
	 if  ( $my_query->have_posts() ) { 
	    ...
	    echo '<ul class="posts-listing__items posts-listing--grid-view posts-listing--related">';  
	    ...
	    while( $my_query->have_posts() ) {
		  ...
		  if  ( has_post_thumbnail() ) { 
		    echo '<a href="' . $my_link . '" class="media__img">';
		    the_post_thumbnail( 'homepage-thumb' ); 
		    echo '</a>'; 
		  };
		    echo '<div class="media__content">';
		    echo '<p class="post__meta">' . $my_date . '</p>';
		    echo '<p><a href="' . $my_link . '">';
		    echo $my_title;
		    echo '</a></p>';
		    echo '</div><!-- .media__content -->';
		    echo '</li><!-- .media -->';
		 }  
    		}  		   
	...
	echo '</ul></div></div><!-- end .posts-listing -->';
}
endif;
